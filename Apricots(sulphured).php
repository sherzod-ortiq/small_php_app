<?php
	...
	session_start();
	$_SESSION['address'] = "Apricots(sulphured).php";
...
<html>
	...
	<head>
		<link href = "css/stylesApricots(sulphured)Authenticated.css" type = "text/css" rel = "stylesheet">
		<meta http-equiv = "Content-Type" content = "text/html; charset=utf-8">
			<title>Apricots(sulphured), Dried fruits of Tutkey</title>
	</head>
		...
		<body>
			...
			<div id = "image1wrapper">
				<img id = "image1" src = "source/05.jpeg" width = "500" height = "277">
					<div id = "image1name">
      ...
      <div id = image2wrapper>
				<img id = "image2" src="source/06.jpeg" width = "400" height = "300">
					<div id = "image2name">
						10 kilo packing.
					</div>
			</div>
...
<html>
	...
	<head>
		<link href = "css/stylesApricots(sulphured).css" type = "text/css" rel = "stylesheet">
		<meta http-equiv = "Content-Type" content = "text/html; charset=utf-8">
