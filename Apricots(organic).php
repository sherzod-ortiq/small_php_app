<?php
	...
	session_start();
	$_SESSION['address'] = "Apricots(organic).php";
...
<html>
	...
	<head>
		<link href = "css/stylesApricots(organic)Authenticated.css" type = "text/css" rel = "stylesheet">
		<meta http-equiv = "Content-Type" content = "text/html; charset=utf-8">
			<title>Organic Apricots, Dried fruits of Turkey</title>
	</head>
		...
		<body>
			...
			<div id = "image1wrapper">
				<img id = "image1" src = "source/01.jpeg" width = "500" height = "277">
					<div id = "image1name">
						Sun dried organic apricots.
					</div>
			</div>
			aaaaaaaaaaaaa
      ...
      <div id = image2wrapper>
				<img id = "image2" src="source/04.jpeg" width = "400" height = "300">
					<div id = "image2name">
						10 kilo packing.
					</div>
			</div>
...
<html>
	...
	<head>
		<link href = "css/stylesApricots(organic).css" type = "text/css" rel = "stylesheet">
		<meta http-equiv = "Content-Type" content = "text/html; charset=utf-8">
